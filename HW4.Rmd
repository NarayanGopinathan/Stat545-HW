...
# I will make a tibble with one row per year, and columns for life expectancy and GDP per capita in two countries, Japan and China.
```{r}
...
```
# I  will re-lengthen the data by putting it into fewer columns.
```{r, comment = NA}
multi_wide %>%
  pivot_longer(cols = (-year), 
